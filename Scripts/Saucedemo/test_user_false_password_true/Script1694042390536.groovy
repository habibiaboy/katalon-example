...
WebUI.setText(findTestObject('Saucedemo/Page_Swag Labs/input_Swag Labs_user-name'), GlobalVariable.user_false)

WebUI.delay(2)

WebUI.setText(findTestObject('Saucedemo/Page_Swag Labs/input_Swag Labs_password'), GlobalVariable.password_true)
